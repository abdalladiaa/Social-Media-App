...
return (
  <div className="relative">
        ...
        <div className="flex items-center px-2 sm:px-3">
          ...
          <div className="flex shrink-0 items-center">
            <label
              ...
              className="cursor-pointer p-1.5 text-gray-400 transition-colors hover:text-blue-500 sm:p-2"
            >
    ...
    {showEmoji && (
      <div
        ref={emojiPickerRef}
        className="absolute bottom-full right-0 z-50 mb-2 w-[280px] sm:w-[320px] overflow-hidden rounded-2xl border shadow-2xl"
      >
        <EmojiPicker
